                      ...
                      <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterData/updateHakAkses/doUpdate/'.$id));?>">
                          ...
                          <?php foreach ($parentModul as $key): ?>
                            <div class="col-md-12">
                                        ...
                                        <input type="checkbox" name="class_parent_modul[]" value="<?php echo $key->class;?>" onchange="cek('<?php echo $key->class;?>')" class="pull-right" id="parent<?php echo $key->class;?>" <?php if(cekParentModulPengguna($key->class,$id) == TRUE){ echo "checked";}?>>
                  								</h3>
                  							</div>
                                <?php if ($key->child_module=='Y'): ?>
                  							<div id="<?php echo $key->class;?>" class="panel-collapse collapse <?php if(cekParentModulPengguna($key->class,$id) == TRUE){ echo "in";}?>">
                  								<div class="panel-body">
                                    <table class="table table-striped table-bordered">
                                      ...
                                      <tbody>
                                        ...
                                        <?php if ($row->type_modul=='R'): ?>
                                              <td style="background-color:green;color:white;"><input type="checkbox" name="controller_modul[]" value="<?php echo $row->controller_modul;?>" <?php if(cekModulPengguna($row->controller_modul,$id) == TRUE){ echo "checked";}?>></td>
                                          ...
                                          <?php else: ?>
                                              <td><input type="checkbox" name="controller_modul[]" value="<?php echo $row->controller_modul;?>" <?php if(cekModulPengguna($row->controller_modul,$id) == TRUE){ echo "checked";}?>></td>
