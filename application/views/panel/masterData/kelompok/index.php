  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Import Data Kelompok</h4>
      </div>
      <div class="modal-body">
        <form class="" action="<?php echo base_url('panel/masterData/createKelompok/doImport'); ?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label for="">Upload File Disini</label>
            <input type="file" accept="application/msexcel" name="dataKelompok" class="form-control">
            <font color="red">*Upload data dengan format xlsx</font><br />
            <b><a href="<?php echo base_url('assets/excel/Format_Data_Kelompok.xlsx'); ?>">Download format import data disini</a></b><br />
          </div>
      </div>
