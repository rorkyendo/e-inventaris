    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/inventori/updateInventoriMasuk/doUpdate/'.$row->id_faktur)); ?>" enctype="multipart/form-data">
          <div class="col-md-12">
          <center>
                ...
                <div class="panel-body" id="groupInvent">
                  <?php foreach($detailFaktur as $key):?>
                    ...
                    <div class="col-md-12" id="inventori<?php echo $key->id_inventori;?>">
                      ...
                      <div class="col-md-3">
                        <label for="">Harga Inventori</label>
                        <input type="number" name="harga_barang[]" class="form-control" value="<?php echo $key->harga_barang_faktur;?>" required>
                      </div>
                    </div>
                  <?php endforeach;?>
                </div>
