    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/inventori/createLogistikMasuk/doCreate/')); ?>" enctype="multipart/form-data">
            <div class="col-md-12">
              ...
              <div class="panel panel-inverse" id="groupInvent">
                ...
                <div class="panel-body">
                  ...
                  <div class="col-md-3">
                    <input type="text" onkeypress="return isNumberKey(event)" name="harga_pokok[]" id="harga_pokok" class="form-control" placeholder="Masukkan Harga Pokok Per Satuan" required>
                  </div>
                </div>
              </div>
              <div class="col-md-12">
