          ...
          <center>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" value="<?php echo $row->nim_mahasiswa;?>" placeholder="Masukkan NIM Mahasiswa apabila peminjaman dilakukan oleh mahasiswa" name="nim_mahasiswa"/>
                </div>
              </div>
              <div class="form-group">
