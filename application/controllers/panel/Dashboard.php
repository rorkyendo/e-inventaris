...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$data['jmlPengguna'] = $this->GeneralModel->count_general('disdik_pengguna');
		...
		$data['pengguna'] = $this->GeneralModel->get_by_id_general('disdik_pengguna','uuid_pengguna',$this->session->userdata('uuid_pengguna'));
		$data['kataMutiara'] = $this->GeneralModel->limit_general_order_by('disdik_kata_mutiara', 'RAND()', '' ,1);
