...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function getAnnotOptFromJSProp($prop, &$spot_colors, $rtl=false) {
		...
		// password_pengguna: Specifies whether the field should display asterisks when data is entered in the field.
		if (isset($prop['password_pengguna']) AND ($prop['password_pengguna'] == 'true')) {
			$ff += 1 << 13;
		}
